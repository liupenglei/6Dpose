...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelcfg', type=str, default='cfg/MFPN-yolov4-pose.cfg')
    parser.add_argument('--weightfile', type=str, default='backup/duck/MFPNmodel1.weights') # imagenet initialized weights
