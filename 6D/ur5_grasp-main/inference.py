        ...
        for box_pr, target in zip([all_boxes], [target[0]]):
            ...
            for k in range(num_gts):
                ...
                if visualize:
                    ...
                    # plt.imshow(resize(img, output_shape=(im_height, im_width).reshape(1, im_height * im_width * 3)).T)
...
img_test = Image.open('./save.jpeg')

x,y = test(modelcfg, weightfile, img_test)
print("x = ", x , ",y = ",y)